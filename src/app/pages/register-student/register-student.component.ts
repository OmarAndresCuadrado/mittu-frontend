...
export class RegisterStudentComponent implements OnInit {
  ...
  register() {
    ...
    this.studentName = this.registerStudentForm.value.name;

    this.registerStudentService.registerStudent(this.registerStudentForm.value)
      .subscribe((resp) => {
      }, (err) => {
      })
  ...
  setDeparament(deparament: String) {
    this.registerStudentForm.value.deparament = deparament;
  }

  setCity(city: String) {
    this.registerStudentForm.value.city = city;
  }
  ...
  showNotification() {
    setTimeout(() => {
      ...
      Swal.fire({
        ...
        html: `Bienvenido ${this.studentName} ya puedes ingresar a la plataforma <br> <b>Nota<b> <br> <p style="color:green;">En breve recibiras tus datos de ingreso en el correo </p>`,
        icon: 'success',
