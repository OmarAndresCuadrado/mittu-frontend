...
export class RegisterTeacherComponent implements OnInit {
  ...
  public citiesFromDeparament: any[] = [];
  public listOfDeparaments: any[] = [];
  public citySelected: any;
  public deparamentSelected: any;
  public teacherName: any;
  public deparamentsAndCities: any[] = [
    {
      "id": 0,
  ...
  ngOnInit(): void {
    this.getDeparaments();
    this.getCitiesFromADeparaments("Amazonas");
  ...
  register() {
    ...
    this.teacherName = this.registerTeacherForm.value.name;

    this.registerTeacherService.registerTeacher(this.registerTeacherForm.value)
      .subscribe((resp) => {
      }, (err) => {
      })
  ...
  getCitiesFromADeparaments(deparament: String) {
    this.filterArray = this.deparamentsAndCities.filter(obj => obj.departamento === deparament);
    this.filterArray[0].ciudades.forEach(city => {
      this.citiesFromDeparament.push(city);
    });
  }

  getDeparaments() {
    this.deparamentsAndCities.forEach(element => {
      this.listOfDeparaments.push(element.departamento);
    });
  }

  setDeparament(deparament: String) {
    this.deparamentSelected = deparament;
    this.registerTeacherForm.value.deparament = this.deparamentSelected;;
  }

  setCity(city: String) {
    this.citySelected = city;
    this.registerTeacherForm.value.city = this.citySelected;
  }
  ...
  showNotification() {
    setTimeout(() => {
      ...
      Swal.fire({
        ...
        html: `Bienvenido ${this.teacherName} ya puedes ingresar a la plataforma <br> <b>Nota<b> <br> <p style="color:green;">En breve recibiras tus datos de ingreso en el correo </p>`,
        icon: 'success',
